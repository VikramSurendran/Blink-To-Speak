...
public class FaceMeshResultImageView extends AppCompatImageView {
  ...
  private static final int TESSELATION_THICKNESS = 2; // Pixels
  private static final int RIGHT_EYE_COLOR = Color.parseColor("#EC407A");
  private static final int RIGHT_EYE_THICKNESS = 6; // Pixels
  private static final int RIGHT_EYEBROW_COLOR = Color.parseColor("#E0E0E0");
  private static final int RIGHT_EYEBROW_THICKNESS = 4; // Pixels
  private static final int LEFT_EYE_COLOR = Color.parseColor("#EC407A");
  private static final int LEFT_EYE_THICKNESS = 6; // Pixels
  private static final int LEFT_EYEBROW_COLOR = Color.parseColor("#E0E0E0");
  private static final int LEFT_EYEBROW_THICKNESS = 4; // Pixels
  private static final int FACE_OVAL_COLOR = Color.parseColor("#E0E0E0");
  private static final int FACE_OVAL_THICKNESS = 4; // Pixels
  private static final int LIPS_COLOR = Color.parseColor("#E0E0E0");
  private static final int LIPS_THICKNESS = 4; // Pixels
  private static final int LINE_COLOR = Color.parseColor("#03F4FC");
  private static final int LINE_THICKNESS = 3; // Pixels
  ...
  public void setFaceMeshResult(FaceMeshResult result) {
    ...
    for (int i = 0; i < numFaces; ++i) {
      ...
      if (result.multiFaceLandmarks().get(i).getLandmarkCount()
        ...
        drawLineLandmarks(
                canvas,
                result.multiFaceLandmarks().get(i).getLandmarkList().get(263),
                result.multiFaceLandmarks().get(i).getLandmarkList().get(362),
                imageSize,
                LINE_COLOR,
                LINE_THICKNESS);
        drawLineLandmarks(
                canvas,
                result.multiFaceLandmarks().get(i).getLandmarkList().get(133),
                result.multiFaceLandmarks().get(i).getLandmarkList().get(33),
                imageSize,
                LINE_COLOR,
                LINE_THICKNESS);
      }
  ...
  private void drawLineLandmarks(
          Canvas canvas,
