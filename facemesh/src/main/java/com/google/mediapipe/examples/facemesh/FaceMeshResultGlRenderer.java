...
public class FaceMeshResultGlRenderer implements ResultGlRenderer<FaceMeshResult> {
  ...
  private static final float[] RIGHT_EYE_COLOR = new float[] {0.925f, 0.251f, 0.475f, 1f};
  private static final int RIGHT_EYE_THICKNESS = 7;
  private static final float[] RIGHT_EYEBROW_COLOR = new float[] {0.9f, 0.9f, 0.9f, 1f};
  private static final int RIGHT_EYEBROW_THICKNESS = 4;
  private static final float[] LEFT_EYE_COLOR = new float[] {0.925f, 0.251f, 0.475f, 1f};
  private static final int LEFT_EYE_THICKNESS = 7;
  private static final float[] LEFT_EYEBROW_COLOR = new float[] {0.9f, 0.9f, 0.9f, 1f};
  private static final int LEFT_EYEBROW_THICKNESS = 4;
